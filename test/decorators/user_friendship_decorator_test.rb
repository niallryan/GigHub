...
class UserFriendshipDecoratorTest < Draper::TestCase
  ...
  context "#sub_message" do
    setup do
      @friend = create(:user, first_name: 'Emma')
    end
    ...
    context "with a pending user friendship" do
      ...
      should "return the correct message" do
        assert_equal "Do you really want to be friends with Emma?", @decorator.sub_message
      end
    end
    ...
    context "with an accepted user friendship" do
      ...
      should "return the correct message" do
        assert_equal "You are friends with Emma.", @decorator.sub_message
      end
    end
